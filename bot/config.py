...
SCHEDULED_MESSAGES = [
    {
        "time": "09:00",
        "text": "Вот и он — день свадьбы! ☀️ Владимир и Алина проснулись (надеемся) и уже нервничают. Сегодня всё будет хорошо. Можете начинать наряжаться.",
    },
    {
        "time": "11:30",
        "text": "Напоминаем: свадьба — не повод опаздывать. Особенно если яхта не ждёт 🛥️",
    },
    {
        "time": "14:00",
        "text": "До отплытия 2,5 часа. Самое время проверить: костюм, туфли, подарок, себя.",
    },
    {
        "time": "15:30",
        "text": "Выдвигаемся! Яхт-клуб «Буревестник», яхта «Алиса». Навигатор не подведёт, мы верим.",
    },
    {
        "time": "16:30",
...
SYSTEM_PROMPT = """Ты — весёлый тамада свадьбы Владимира и Алины.
...
WELCOME_TEXT = (
    "Привет! Я настоящий AI-тамада свадьбы Владимира и Алины 🎩 "
    "Тот, что молчал раньше — это был лже-тамада. Засланный казачок. "
    "Теперь я здесь, и всё под контролем. "
